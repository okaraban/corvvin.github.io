/*MVC
Model = данные
View = вид, отображение, представление данных
Controller = управление, манипуляция данными*/
	...
	ulElement.innerHTML = ''
		...
		for (let index = 0; index < todoList.length; index++) {
			...
			if (!todoItem.done) {
				...
				buttonDoneElement.className = 'btn btn-outline-primary ml-2'
				...
				buttonRemoveElement.className = 'btn btn-outline-danger ml-2'
